 ...
 */
public class LivePersonDynamicInclude extends ProviderDynamicInclude {

	public LivePersonDynamicInclude(String providerAccountToken, User user) {
	...
	private static final String _MAIN_TEMPLATE_CLASSPATH_PATH =
		"/template/liveperson-template.js";
