...
<aui:input disabled="<%= !systemSettingsEnabled || Objects.equals(groupProviderTokenStrategy, GroupProviderTokenStrategy.ALWAYS_INHERIT.getValue()) %>" label="group-provider-account-token" name='<%= "TypeSettingsProperties--" + ClickToChatWebKeys.CLICK_TO_CHAT_GROUP_PROVIDER_ACCOUNT_TOKEN + "--" %>' type="text" value="<%= GetterUtil.getString(request.getAttribute(ClickToChatWebKeys.CLICK_TO_CHAT_GROUP_PROVIDER_ACCOUNT_TOKEN)) %>" />

<aui:select disabled="<%= !systemSettingsEnabled || Objects.equals(groupProviderTokenStrategy, GroupProviderTokenStrategy.ALWAYS_INHERIT.getValue()) %>" label="provider" name='<%= "TypeSettingsProperties--" + ClickToChatWebKeys.CLICK_TO_CHAT_PROVIDER + "--" %>' value="<%= GetterUtil.getString(request.getAttribute(ClickToChatWebKeys.CLICK_TO_CHAT_PROVIDER)) %>">
